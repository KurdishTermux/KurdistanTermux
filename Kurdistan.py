...
\033[1;93mTELEGRAM CHANALL\033[1;93m:❥•❥•❥•❥• \033[1;93m@NemaJare
\033[1;93mYoutube Me\033[1;93m:❥•❥•❥•❥• \033[1;93m@                   
\033[1;98m                ❥KURDSTAN UP ❥  
\033[1;98m                ❥ :(FUCK LOVE ): ❥           
\033[1;91m———————————————————————————————♦♦♦
"""
def tik():
...
jalan("\033[1;91m•◈•───────•◈ SUBSCRIBE MY Youtube CHANNEL Kurdish Top Smart•◈•───────•◈•")  
...
CorrectUsername = "Kurdistan"
CorrectPassword = "Termux"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('https://youtube.com/channel/UCD3gyTvQb-sPcawKjrPrWBg')
    else:
...
def menu():
	...
	print "\033[1;32;40m[2] \033[1;33;40m══Update Termux"																														
...
def pilih():
	...
	if unikers =="":
		...
		os.system('clear')
		print logo
		print " \033[1;36;40m●════════════════════════◄Kurdistan Termux►════════════════════════●\n"
...
def pilih_super():
	...
	print "   \033[1;31;48m●💋══════════════════◄Kurdistan Termux►══════════════════💋●"

	jalan('                    \033[1;97mZakria start cloning Wait...')
	print  "  \033[1;36;48m ●💋══════════════════◄Kurdistan Termux►══════════════════💋●" 
